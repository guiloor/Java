...
public class Main extends Canvas implements Runnable {
	...
	private void mostrar() {
		...
		mapa.mostrar(jugador.obtenerPosicionX() - pantalla.getAncho() /2 + jugador.obtenerSprite().obtenLado()/2,
				jugador.obtenerPosicionY() - pantalla.obtenAlto() /2 + jugador.obtenerSprite().obtenLado()/2 pantalla);
